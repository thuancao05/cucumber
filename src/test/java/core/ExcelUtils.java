...
public class ExcelUtils {
    ...
    public static void writeHeadingExcelFile() throws IOException{
        ...
        try {
            FileOutputStream fileOutputStream = new FileOutputStream("resources/testResult.xlsx");
    ...
    public static void writeAppendExcelFile(String testcase, String result) throws IOException {
        FileInputStream fileInputStream = new FileInputStream("resources/testResult.xlsx");
